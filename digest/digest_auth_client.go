...
func SelfCheckRedirect(req *http.Request, via []*http.Request) error {
	//fmt.Println("重定向", req.RequestURI)
...
func (dr *DigestRequest) Execute() (resp *http.Response, err error) {
	...
	//fmt.Println(dr.Method,dr.URI,dr.Body)
	...
	client.CheckRedirect = SelfCheckRedirect
